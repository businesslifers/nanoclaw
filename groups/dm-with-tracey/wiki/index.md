---
scope: group
group: dm-with-tracey
title: Janet
description: Janet wiki — agent-maintained persistent knowledge base.
updated: 2026-05-12
---

# Janet Wiki — Index

Knowledge base for the **Janet** agent group. Read this file FIRST on any query so you can pull from existing pages instead of re-deriving from raw sources.
