...
group: crm
title: CRM
description: CRM wiki — agent-maintained persistent knowledge base.
updated: 2026-05-01
---

# CRM Wiki — Index

Knowledge base for the **CRM** agent group. Read this file FIRST on any query so you can pull from existing pages instead of re-deriving from raw sources.
