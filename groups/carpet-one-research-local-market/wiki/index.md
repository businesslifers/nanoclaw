...
description: Local Market Analyst wiki — agent-maintained persistent knowledge base.
updated: 2026-06-02
---

# Local Market Analyst Wiki — Index

Knowledge base for the **Local Market Analyst** agent group. Read this file FIRST on any query so you can pull from existing pages instead of re-deriving from raw sources.
