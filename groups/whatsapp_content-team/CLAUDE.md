...
- **Geographic audience focus:** Tier 1 markets: US, UK, Australia, Canada (US/UK/AU/CA). Tier 2 high-value markets: New Zealand, Germany, Netherlands, Nordics (Sweden/Norway/Denmark/Finland). Do not plan, write, or optimise content for broad/global audiences beyond these — this attracts bot and low-quality traffic. Applies to all active sites (BB, ICT, LPG) and any new sites.
