---
scope: group
group: carpet-one-pm-project
title: PM
description: PM wiki — agent-maintained persistent knowledge base.
updated: 2026-06-02
---

# PM Wiki — Index

Knowledge base for the **PM** agent group. Read this file FIRST on any query so you can pull from existing pages instead of re-deriving from raw sources.
