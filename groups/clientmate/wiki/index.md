...
group: clientmate
title: clientmate
description: clientmate wiki — agent-maintained persistent knowledge base.
updated: 2026-05-01
---

# clientmate Wiki — Index

Knowledge base for the **clientmate** agent group. Read this file FIRST on any query so you can pull from existing pages instead of re-deriving from raw sources.
