...
## [2026-07-10] lint | 1 fixed, 0 broken links, 3 open items
Health check. All 10 pages (8 content + 2 source summaries) indexed. Cross-references all resolve: inline relative links + every frontmatter `related:`/`sources:` target, 0 broken (the lone `](url)` in reporting-pipeline.md is a literal Slack-formatting example). No orphans, no contradictions; both raw sources (`v1-conversations/2026-04-08-conversation-2312.md`, `v1-scheduled-tasks.md`) have summary pages — none unprocessed. Fixed: index `updated`/`lint` frozen at 2026-07-03 despite `concepts/local-pack-conversion-gap.md` added Jul 6 → bumped to 2026-07-10. Open items: (1) month-end MTD date-bug code fix still outstanding, next risk Jul 31; (2) no per-client entity pages for the 7 active clients (carried since May 8, covered by client-list topic); (3) `concepts/local-pack-conversion-gap.md` is a candidate for global-wiki promotion if the pattern recurs across groups.

## [2026-07-06] audit+ingest | All-account campaign audit for Raels; filed local-pack conversion gap
Ran a full-account campaign audit (work item wi-1783313304338-u5rsif, from Raels via dashboard) across all 7 active accounts / 50 campaigns off data date 2026-07-05. Delegated data classification to analyst, formatting to reporter; posted to #marketing-team (msg 85). Critical findings: Caloundra + Maroochydore fully dark ($0 MTD, all campaigns paused), Logan City wound to 1/13 live, 1 disapproved asset on a live Haus PMax, several enabled campaigns 0-conv + severely rank-limited. Filed new concept page `concepts/local-pack-conversion-gap.md` (5 of 8 zero-conv campaigns were Local-pack/Local-listing formats across 5 accounts = likely missing GBP conversion mapping, not dead campaigns) and linked it in the index. Candidate for global-wiki promotion if it recurs across groups.
