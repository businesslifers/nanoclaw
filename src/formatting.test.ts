...
describe('TRIGGER_PATTERN', () => {
  ...
  it('matches when trigger appears mid-message (word boundary, not start anchor)', () => {
    // Our customization: \b word boundary instead of ^ start anchor
    // so @Derek triggers anywhere in the message
